...
class _ApiService implements ApiService {
  _ApiService(
    ...
    baseUrl ??= 'https://master-market.masool.net/api/';
  }
  ...
  @override
  Future<SliderProductModel> getSliderProducts() async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<SliderProductModel>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late SliderProductModel _value;
    try {
      _value = SliderProductModel.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
  ...
  Future<CategoryModel> getCategories() async {
    ...
    final _options = _setStreamType<CategoryModel>(Options(
      ...
      extra: _extra,
        ...
        .compose(
          _dio.options,
          '/categories/get_with_sub/ar/0/0',
          queryParameters: queryParameters,
          data: _data,
        )
        .copyWith(
  ...
  Future<ProductModel> getAllProducts(
    ...
    final _options = _setStreamType<ProductModel>(Options(
      ...
      extra: _extra,
        ...
        .compose(
          _dio.options,
          '/products/t/ar/0/0/0?page=${pageNum}&user_id=${userId}',
          queryParameters: queryParameters,
          data: _data,
        )
        .copyWith(
  ...
  @override
  Future<FavoriteProductModel> getFavoriteProducts() async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<FavoriteProductModel>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late FavoriteProductModel _value;
    try {
      _value = FavoriteProductModel.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
  ...
  @override
  Future<void> addOrDeleteFavoriteProduct(int id) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
